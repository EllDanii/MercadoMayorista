...
public class VentanaActualizar extends JFrame {
	...
	private JLabel titulo, panPesoCarne, panPesoPapas, panMililitros, panTipo, panColor, panCorte, panCantidad,
			panAzucar, panSaborChicle, panSaborPapas, panCalorias, panMarca, panPrecio, panMarcaVie, panCorteVie;

	private JTextField entPesoCarne, entPesoPapas, entMililitros, entTipo, entColor, entCorte, entCantidad, entAzucar,
			entSaborChicle, entSaborPapas, entCalorias, entMarca, entPrecio, entMarcaVie, entCorteVie;

	private JButton botonActualizar, botonVolver;
	...
	public VentanaActualizar() {
		...
		entMarcaVie = new JTextField();
		entMarcaVie.setBounds(60, 400, 700, 40);

		panMarcaVie = new JLabel();
		panMarcaVie.setBounds(800, 400, 700, 40);
		panMarcaVie.setText("<-- Marca antigua");
		panMarcaVie.setForeground(Color.black);
		panMarcaVie.setFont(new Font("Arial", Font.BOLD, 13));
		
		entCorteVie = new JTextField();
		entCorteVie.setBounds(60, 400, 700, 40);

		panCorteVie = new JLabel();
		panCorteVie.setBounds(800, 400, 700, 40);
		panCorteVie.setText("<-- Corte antiguo");
	...
	public void setBotonActualizar(JButton botonCrear) {
		this.botonActualizar = botonCrear;
	}
	...
	public JLabel getPanMarcaVie() {
		return panMarcaVie;
	}

	public void setPanMarcaVie(JLabel panMarcaVie) {
		this.panMarcaVie = panMarcaVie;
	}

	public JLabel getPanCorteVie() {
		return panCorteVie;
	}

	public void setPanCorteVie(JLabel panCorteVie) {
		this.panCorteVie = panCorteVie;
	}

	public JTextField getEntMarcaVie() {
		return entMarcaVie;
	}

	public void setEntMarcaVie(JTextField entMarcaVie) {
		this.entMarcaVie = entMarcaVie;
	}

	public JTextField getEntCorteVie() {
		return entCorteVie;
	}

	public void setEntCorteVie(JTextField entCorteVie) {
		this.entCorteVie = entCorteVie;
	}
